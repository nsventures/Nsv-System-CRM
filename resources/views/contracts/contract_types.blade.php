...
<div class="container-fluid">
    <div class="d-flex justify-content-between mb-2 mt-4">
        ...
        <div>
            <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#create_contract_type_modal"><button type="button" class="btn btn-sm btn-primary action_create_contract_types" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-original-title=" <?= get_label('create_contract_type', 'Create contract type') ?>"><i class="bx bx-plus"></i></button></a>
            <a href="{{url('contracts')}}"><button type="button" class="btn btn-sm btn-primary action_manage_contracts" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-original-title="<?= get_label('contracts', 'Contracts') ?>"><i class='bx bx-list-ul'></i></button></a>
        </div>
    </div>
    @if ($contract_types > 0)
    <div class="card">
