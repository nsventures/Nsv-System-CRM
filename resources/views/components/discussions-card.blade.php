<div class="d-flex justify-content-between">
    ...
    <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#commentModal">
        <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="{{ get_label('add_comment', 'Add Comment') }}">
    ...
    <div class="comment-thread">
        ...
        <details open class="comment" id="comment-{{ $comment->id }}">
            ...
            <summary>
                <div class="comment-heading">
                    ...
                    <div class="comment-actions d-flex ms-5 p-0">
                        ...
                        <a href="javascript:void(0);" data-comment-id="{{ $comment->id }}" class="btn btn-sm text-danger delete-comment p-0" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ get_label('delete', 'Delete') }}">
            ...
            <div class="comment-body">
                ...
                <div class="attachments mt-2">
                    ...
                    <div class="attachment-item d-flex align-items-center justify-content-between">
                        <div class="attachment-preview-container">
                            <a href="{{ asset('storage/' . $attachment->file_path) }}" target="_blank" class="attachment-link" data-preview-url="{{ asset('storage/' . $attachment->file_path) }}">
                ...
                @endif
                <button type="button" class="open-reply-modal mt-3" data-comment-id="{{ $comment->id }}">{{ get_label('reply', 'Reply') }}</button>
            </div>
            ...
            <div class="replies">
                ...
                <details open class="comment" id="comment-{{ $reply->id }}">
                    <a href="#comment-{{ $reply->id }}" class="comment-border-link">
                        <span class="sr-only">{{ get_label('jump_to_comment', 'Jump to Comment') }}-{{ $reply->id }}</span>
                    </a>
                    <summary>
                        <div class="comment-heading">
                            <div class="comment-avatar">
                            ...
                            <div class="comment-actions d-flex ms-5 p-0">
                                ...
                                <a href="javascript:void(0);" data-comment-id="{{ $reply->id }}" class="btn btn-sm text-danger delete-comment p-0" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ get_label('delete', 'Delete') }}">
                                    <i class="bx bx-trash"></i>
                                </a>
                            </div>
                            @endif
