...
@section('title')
    {{ get_label('edit_social_account', 'Edit Social Account') }}
@endsection
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                <form id="social-account-form" method="POST" action="{{ route('social.accounts.update', $account->id) }}">
                    @csrf
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" id="status" name="status" required>
                                <option value="active" {{ $account->status == 'active' ? 'selected' : '' }}>{{ get_label('active', 'Active') }}</option>
                                <option value="inactive" {{ $account->status == 'inactive' ? 'selected' : '' }}>{{ get_label('inactive', 'Inactive') }}</option>
                            </select>
                        </div>
                    </div>
                    ...
                    @php
                        $settings = $account->social_settings ?? [];
                    @endphp
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="facebook_page_id" 
                                    ...
                                    value="{{ $settings['facebook']['facebook_page_id'] ?? '' }}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="facebook_access_token" 
                                    ...
                                    value="{{ $settings['facebook']['facebook_access_token'] ?? '' }}"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="instagram_business_account_id" 
                                    ...
                                    value="{{ $settings['instagram']['instagram_business_account_id'] ?? '' }}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="instagram_access_token" 
                                    ...
                                    value="{{ $settings['instagram']['instagram_access_token'] ?? '' }}"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="linkedin_person_id" 
                                    ...
                                    value="{{ $settings['linkedin']['linkedin_person_id'] ?? '' }}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="linkedin_access_token" 
                                    ...
                                    value="{{ $settings['linkedin']['linkedin_access_token'] ?? '' }}"
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="pinterest_app_id" 
                                    ...
                                    value="{{ $settings['pinterest']['pinterest_app_id'] ?? '' }}"
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="pinterest_app_secret" 
                                    ...
                                    value="{{ $settings['pinterest']['pinterest_app_secret'] ?? '' }}"
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="pinterest_app_type" 
                                    name="pinterest_app_type" 
                                    value="{{ $settings['pinterest']['pinterest_app_type'] ?? '' }}"
                                    placeholder="Enter Pinterest App Type">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="youtube_client_id" 
                                    ...
                                    value="{{ $settings['youtube']['youtube_client_id'] ?? '' }}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="youtube_client_secret" 
                                    ...
                                    value="{{ $settings['youtube']['youtube_client_secret'] ?? '' }}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="youtube_access_token" 
                                    ...
                                    value="{{ $settings['youtube']['youtube_access_token'] ?? '' }}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="youtube_refresh_token" 
                                    ...
                                    value="{{ $settings['youtube']['youtube_refresh_token'] ?? '' }}"
