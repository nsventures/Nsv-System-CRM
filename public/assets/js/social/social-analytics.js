$(document).ready(function () {
    ...
    function formatHour(hour) {
        ...
        const displayHour = ((h + 11) % 12 + 1); // convert 0→12, 13→1
    ...
    function updatePlatformStatsTable() {
        ...
        // Filter platforms with data and prepare chart data
        ...
        const options = {
            ...
            chart: {
                type: 'bar',
                height: platformData.length * 45 + 120, // compact
                stacked: true,
                stackType: '100%',
                toolbar: { show: false },
    ...
    function showAlert(type, message) {
        // Simple alert - you can replace with your toast system
        if (type === 'error') {
