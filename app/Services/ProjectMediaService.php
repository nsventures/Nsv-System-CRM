...
class ProjectMediaService
{
     ...
     */
    public function uploadMedia(Project $project, array $mediaFiles): array
    {
        $mediaIds = [];
    ...
    /**
     * Get media files for a project with search and sorting
     */
    public function getMedia(Project $project, ?string $search = null, string $sort = 'id', string $order = 'DESC'): Collection
    {
